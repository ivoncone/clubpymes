...
from .views import HomeView, SeccionView, SeccionList, Detail, Publicar, UpdatePublicacion, Delete, LikeView, Comentario
...
urlpatterns = [
	...
	path('publicacion/<int:pk>/comentario', Comentario.as_view(), name='comentario'),
]